    ...
    <main className="w-full bg-white text-gray-900 dark:bg-background dark:text-foreground">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-32">
          ...
          >
            Ensure your everyday Office 365 productivity suite is secure from data loss,
            misconfigurations, and cyber risks across the UAE.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={sectionReveal} className="text-center mb-16">
            ...
            <p className="mt-6 max-w-4xl mx-auto text-lg leading-relaxed text-gray-700 dark:text-muted-foreground">
              Microsoft Office 365 is the most widely used productivity suite globally.
              Despite built-in protections, risks remain due to misconfigurations,
              weak access controls, and improper security policies.
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
            ...
            {[
              ['Policy Configuration', 'Implement essential security policies and monitoring.'],
              ['Data Protection', 'Prevent data loss using encryption and access controls.'],
              ['Compliance Assurance', 'Meet Office 365 compliance requirements.'],
              ['Threat Monitoring', 'Detect and mitigate cloud-based threats.'],
              ['Employee Awareness', 'Reduce human-driven security risks.'],
              ['IT Burden Reduction', 'Allow IT teams to focus on core business.'],
            ].map(([title, desc], i) => (
              <motion.div
                key={i}
                variants={cardReveal}
      ...
      >
        ...
        <motion.p variants={sectionReveal} className="mb-8 max-w-2xl mx-auto text-lg text-gray-700 dark:text-muted-foreground">
          Protect your Office 365 environment from cyber risks, data loss, and compliance failures.
        </motion.p>
