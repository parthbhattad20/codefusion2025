  ...
  return (
    <main className="w-full bg-gray-50 dark:bg-background text-gray-900 dark:text-foreground">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            {[
              { title: 'OWASP API Top 10', desc: 'Assessment against OWASP API Top 10 vulnerabilities including authorization, authentication, and injection flaws.' },
              { title: 'Business Logic Testing', desc: 'Identify design and implementation flaws that enable unintended API behavior.' },
              { title: 'REST, SOAP & GraphQL', desc: 'Comprehensive testing for REST, SOAP, RPC, and GraphQL APIs.' },
              { title: 'Authentication & Authorization', desc: 'Validate token handling, session management, and access control enforcement.' },
              { title: 'Data Exposure & PII', desc: 'Detect excessive data exposure and sensitive information leakage.' },
              { title: 'Rate Limiting & Abuse', desc: 'Test protection against brute force, abuse, and denial-of-service risks.' },
            ].map((item, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
      ...
      <motion.section
        ...
        viewport={{ once: true, margin: "-120px" }}
        variants={fadeUp}
        className="py-24 px-6 md:px-20 bg-gray-50 dark:bg-background transition-colors"
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
            ...
            <motion.ul variants={fadeUp} className="space-y-6 md:ml-16 text-gray-800 dark:text-gray-200 text-lg leading-relaxed">
