            ...
            {[ 
              {
                ...
                desc: 'Over 33 billion user accounts are expected to be breached, and the number is rising rapidly.',
              },
              {
                title: 'Growing Online Shoppers',
                desc: 'The UAE e-commerce market is expanding fast, making it a prime target for attackers.',
              },
              {
                title: 'Protect Customer Trust',
                desc: 'Security breaches damage trust, brand reputation, and customer loyalty.',
              },
              {
                title: 'Prevent Financial Loss',
                desc: 'Stop fraud, data theft, and downtime that impact revenue.',
              },
              {
                title: 'Regulatory & Compliance Needs',
                desc: 'Meet security and data protection requirements in the UAE.',
              },
              {
                title: 'Business Continuity',
                desc: 'Ensure uninterrupted and secure online operations.',
              },
            ].map((item, i) => (
              <div
                key={i}
