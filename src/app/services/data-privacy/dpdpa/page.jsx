  ...
  >
    <source src="/assets/videos/main.mp4" type="video/mp4" />
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-32">
          ...
          >
            Achieve compliance with India’s Digital Personal Data Protection Act (DPDPA) using structured governance,
            consent management, and risk-based security controls.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={sectionReveal} className="text-center mb-16">
            ...
            <p className="mt-6 max-w-4xl mx-auto text-lg leading-relaxed text-gray-700 dark:text-muted-foreground">
              The Digital Personal Data Protection Act (DPDPA) of India governs lawful processing, storage,
              and protection of personal data.
            </p>

            <p className="mt-6 max-w-4xl mx-auto text-lg leading-relaxed text-gray-700 dark:text-muted-foreground">
              It enforces consent-based processing, individual rights, accountability, breach reporting,
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
            ...
            {[
              ['DPDPA Gap Assessment', 'Identify compliance gaps across data processing activities.'],
              ['Consent Management', 'Design lawful consent mechanisms.'],
              ['Data Principal Rights', 'Enable access, correction, erasure & grievance handling.'],
              ['Privacy Policy & Notices', 'Implement DPDPA-compliant documentation.'],
              ['Breach Response Planning', 'Prepare notification & incident workflows.'],
              ['DPO & Governance Support', 'Establish accountability frameworks.'],
            ].map(([title, desc], i) => (
              <motion.div
                key={i}
                variants={cardReveal}
