    ...
    <main className="w-full bg-white text-gray-900 dark:bg-background dark:text-foreground">
      ...
      <section className="relative h-screen overflow-hidden bg-[#05070d]">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-6 max-w-7xl mx-auto">
          ...
          >
            Protect your critical industrial networks from catastrophic cyberattacks. Our ICS/SCADA security assessments identify risks, prevent disruptions, and safeguard national and global infrastructure.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={sectionReveal} className="text-center mb-16">
            ...
            <p className="mt-6 max-w-4xl mx-auto text-lg leading-relaxed text-gray-700 dark:text-muted-foreground">
              ICS and SCADA systems control critical infrastructures such as oil & gas, power grids, water treatment, and transportation networks. Due to their wide implementation, they are high-value targets for cyberattacks with potentially catastrophic impact.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={sectionReveal} className="ml-10">
              <h2 className="text-2xl font-semibold mb-6">Why ICS/SCADA Security Matters</h2>
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
            ...
            {[
              ['Network Assessment', 'Analyze industrial networks for vulnerabilities and weak points.'],
              ['System Hardening', 'Patch management and secure access controls.'],
              ['Threat Simulation', 'Real-world industrial cyberattack simulation.'],
              ['Incident Response', 'Rapid operational containment planning.'],
              ['Compliance & Reporting', 'Regulatory alignment and risk documentation.'],
              ['Continuous Monitoring', '24/7 anomaly detection for OT systems.'],
            ].map(([title, desc], i) => (
              <motion.div
                key={i}
                variants={cardReveal}
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
            ...
            <motion.ul variants={sectionReveal} className="space-y-6 text-lg text-gray-800 dark:text-muted-foreground">
              <li>• Assess industrial network and control systems</li>
              <li>• Implement segmentation and hardening</li>
              <li>• Simulate cyberattacks</li>
              <li>• Monitor systems continuously</li>
              <li>• Respond rapidly to threats</li>
            </motion.ul>

            <motion.ul variants={sectionReveal} className="space-y-6 ml-20 text-lg text-gray-800 dark:text-muted-foreground">
              <li className="font-semibold">• Operational Continuity</li>
              <li>○ Prevent blackouts & disruptions</li>
      ...
      >
        ...
        <motion.p variants={sectionReveal} className="mb-8 max-w-2xl mx-auto text-lg text-gray-700 dark:text-muted-foreground">
          Minimize risk and protect critical ICS/SCADA systems with expert security testing services.
        </motion.p>
