            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="message" name="message" placeholder="How can we help you secure your assets?" required rows={8} className="min-h-[150px] resize-none"/>
                </div>
            ...
            <CardContent className="space-y-6 text-sm">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:hello@vulnuris.com" className="text-muted-foreground hover:text-primary transition-colors block">hello@vulnuris.com</a>
                  <a href="mailto:connect@vulnuris.com" className="text-muted-foreground hover:text-primary transition-colors block">connect@vulnuris.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="tel:+918208387709" className="text-muted-foreground hover:text-primary transition-colors block">+91 82083 87709</a>
                </div>
              </div>
            </CardContent>
          </Card>
