...
const ContactClient = () => {
  ...
  const products = ["Vaultix", "Phishinstinct", "Kloudraksha", "Vcrypt"];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div variants={fadeUp} className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-muted-foreground max-w-2xl mx-auto">
            Have questions about securing your organization? Reach out and let's
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  <span className="text-violet-800">V</span>'ll get back to you
                  as soon as possible.
                </CardDescription>
              </CardHeader>
              <CardContent>
                            ...
                            {Object.entries(services).map(([main, subs]) => (
                              ...
                              >
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    setExpandedService(
                                      expandedService === main ? null : main,
                                    )
                                  }
                                  className="
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Nitaan Towers, Aundh, Pune, Maharashtra 411007
                        </p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Vulnuris Security Solutions FZCO, A1, IFZA, Dubai, UAE
                        </p>
                      </div>
                    </div>
                  </div>
