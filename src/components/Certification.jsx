export default function Certification() {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 bg-gradient-to-br from-blue-600 to-violet-950 text-white pt-6 md:py-8 rounded-xl mx-2 my-4 lg:mx-8 lg:my-8'>
        <h2 className="text-2xl lg:text-4xl xl:text-5xl font-bold flex flex-col items-center justify-center"><span></span> <span>We're <span className='bg-clip-text text-transparent bg-gradient-to-br from-yellow-400 to-yellow-800'>ISO Certified</span> For It.</span></h2>
