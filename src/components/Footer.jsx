...
export default function Footer() {
  ...
  const certifications = [
    { src: "/assets/ISO-27701-certified.png", alt: "ISO 27701 Certification" },
    { src: "/assets/iso9001.png", alt: "ISO 9001 Certification" },
    { src: "/assets/iso27001.png", alt: "ISO 27001 Certification" },
  ];
                  ...
                  <AnimatePresence>
                    {openService === category && (
                      <motion.div
                        ...
                        className="overflow-hidden mt-2 ml-3 border-l-2 border-primary/25 pl-3"
                      >
                        <motion.ul
                          className="space-y-2"
                          initial="hidden"
